...
<template>
  <div class="card-view">
    <ElScrollbar v-loading="loading">
      <div class="card-grid">
        <div v-for="item in data" :key="item.id" class="alarm-card">
          <div class="card-header">
            <div class="alarm-name">{{ item.alarmName }}</div>
          ...
          <div class="card-body">
            ...
            <div v-if="item.closeTime" class="info-row">
              <span class="label">关闭时间：</span>
              <span class="value">{{ item.closeTime }}</span>
            </div>
            <div v-if="item.confirmer" class="info-row">
